...
var Grid = function (_a) {
    ...
    return container ? (react_1.default.createElement("div", { className: "grid ".concat(director(), " w-full gap-").concat(spacing * 2) }, children)) : (react_1.default.createElement("div", { className: "".concat(spanner(), " ").concat(startPointer()) }, children));
};
